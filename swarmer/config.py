...
class Settings(BaseSettings):
    ...
    claude_preset_plan_variant: str = ""  # optional reasoning variant for the PLAN-role model
    ...
    gemini_preset_plan_variant: str = "high"  # optional reasoning variant for the PLAN-role model
