    ...
    def get_model_options(self, secret=None) -> list[dict]:
        ...
        if secret and secret.has_adc:
            options.extend([
                ...
                {"value": "vertexai/gemini-3-pro", "label": "Gemini 2.5 Pro", "group": "Vertex AI — Gemini"},
                {"value": "vertexai/gemini-3-flash", "label": "Gemini 2.5 Flash (fast)", "group": "Vertex AI — Gemini"},
            ])
